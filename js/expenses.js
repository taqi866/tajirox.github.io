        ...
        function renderExpenses(fExps) {
            ...
            if (typeof window.expensesLimit === 'undefined') {
                window.expensesLimit = (typeof lowResourceMode !== 'undefined' && lowResourceMode) ? 10 : 30;
            }
            const limit = window.expensesLimit;
            const itemsToShow = fExps.slice(0, limit);
        ...
        window.increaseExpensesLimit = function() {

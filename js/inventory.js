    ...
    const items = currentFilteredInventory.filter(i => i.category !== 'خدمة');
        ...
        function renderInventoryCards() {
            ...
            itemsToShow.forEach(item => {
                ...
                const showPurchasePrice = currentUser.role === 'admin' || (currentUser.role === 'staff' && currentUser.showPurchaseToEmployee);
        ...
        <div class="inventory-card ${stockClass}">
            ...
            <div class="card-body">
                <div class="grid grid-cols-2 gap-3 mb-3">
                    ...
                    ` : ''}
                    <div class="${showPurchasePrice ? '' : 'col-span-2'}">
            ...
            openConfirm({
                ...
                onConfirm: (val) => {
                    ...
                    google.script.run.withSuccessHandler(() => {
                        ...
                        setLoading(false); // Removed success toast
        ...
        function openInventoryModal() {
            ...
            const showPurchasePriceInput = currentUser.role === 'admin' || (currentUser.role === 'staff' && currentUser.showPurchaseToEmployee);
            const invPurchaseElement = document.getElementById('invPurchase');
            const invSaleElement = document.getElementById('invSale');

            if (invPurchaseElement) {
                invPurchaseElement.parentElement.style.display = showPurchasePriceInput ? 'block' : 'none';
                invPurchaseElement.required = showPurchasePriceInput;
            }

            if (invSaleElement) {
                invSaleElement.parentElement.style.display = currentUser.purchaseOnly ? 'none' : 'block';
                invSaleElement.required = !currentUser.purchaseOnly;
            }
        ...
        function addProductForConsumption() {
            ...
            // showToast('تمت إضافة المنتج للاستهلاك'); // Removed success toast
        }
        ...
        function confirmConsumption() {
            ...
            performOptimisticAction('consumptions', consumption, false,
                () => {
                    ...
                    // showToast('تم تسجيل الاستهلاك بنجاح'); // Removed success toast
                },

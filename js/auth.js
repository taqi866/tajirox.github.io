...
function handleLoginSuccess(res, loginBtn) {
            ...
            if (res.success) {
                ...
                if (isAdmin) {
                    ...
                    // Afficher les boutons de facture de vente et de service
                    document.getElementById('btnNewSaleInvoice').classList.remove('hidden');
                    document.getElementById('btnNewServiceInvoice').classList.remove('hidden');
        ...
        async function enrollBiometricOnLogin(u, rawPass) {
            ...
            google.script.run
                ...
                .login(u, hashed, null, currentLang);
        }
            ...
            try {
                ...
                if (assertion) {
                    ...
                    google.script.run
                        ...
                        .loginWithBiometricToken(u, token, dbId, currentLang);
                }
            } catch (err) {
        ...
        async function resend2FA() {
            ...
            google.script.run
                ...
                .resend2FACode(window.temp2FASession.username, window.temp2FASession.dbId, currentLang);
        }
